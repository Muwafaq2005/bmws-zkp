...
export function validateTelemetryWindow(window) {
    const errors = [];
...
function validateIdentity(record, window, errors) {
...
function validateSequence(record, index, seenSequences, errors) {
...
function validateTimestamp(records, index, errors) {
    if (index === 0) {
        return;
    }
